...
export const textConfig = {
  ...
  letter: {
    ...
    recipient: "Dear Pucchi >.<",
    paragraphs: [
      "I want to offer my sincerest apologies for the ways I have let you down...",
      "Please forgive me for my mistakes i know its happening again and again but im trying to be better :("
    ],
  ...
  panels: [
    {
      ...
      caption: "I hope you will forgive me."
    },
    {
